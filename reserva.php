...
<body>
    ...
    <div class="container mt-5">
        <h1 class="text-center">Reserva de Go-Karts</h1>
        <form>
            <!-- Nombre -->
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="dia" required>
                    ...
                    <!-- Aquí puedes agregar los días disponibles -->
                    <option value="2024-07-20">20 de Julio de 2024</option>
                    <option value="2024-07-21">21 de Julio de 2024</option>
                    <!-- Añade más opciones según disponibilidad -->
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="espacios" placeholder="Cantidad de espacios disponibles" min="1" required>
            </div>
